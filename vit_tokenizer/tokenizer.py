...
@register_model
def vit_tokenizer(pretrained=False, pretrained_weight=None, as_tokenzer=False, img_size=224, 
    ...
    model = VitTokenizer(encoder_config, decoder_config, n_code, code_dim, teacher_model_type=teacher_model_type, 
