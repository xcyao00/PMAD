...
#             nn.Conv2d(3, 256, kernel_size=7, padding=(7 - 1) // 2),
#             nn.Sequential(
#             nn.Identity(),
#             nn.Sequential(
#                 nn.ReLU(),
#                 nn.Conv2d(256, 64, kernel_size=3, padding=(3 - 1) // 2),
#                 nn.ReLU(),
#                 nn.Conv2d(64, 64, kernel_size=3, padding=(3 - 1) // 2),
#                 nn.ReLU(),
#                 nn.Conv2d(64, 64, kernel_size=3, padding=(3 - 1) // 2),
#                 nn.ReLU(),
#                 nn.Conv2d(64, 256, kernel_size=1, padding=(1 - 1) // 2),
#             )
#             ),
#             nn.Identity(),
#             nn.Sequential(
...
#             nn.Conv2d(256, 256, kernel_size=3, padding=1),
#             nn.ReLU(),
#             nn.Conv2d(256, 1024, kernel_size=1, padding=1),
#       ),
#         nn.Identity(),
#         nn.Sequential(
#             nn.ReLU(),
...
#             nn.Conv2d(512, 512, kernel_size=3, padding=1),
#             nn.ReLU(),
#             nn.Conv2d(512, 2048, kernel_size=1, padding=1),
#         ),
#       nn.Identity(),
#        nn.Sequential(
#            nn.ReLU(),
...
#     nn.Sequential(
#       nn.ReLU(),
#       nn.Conv2d(2048, 8192, kernel_size=1, padding=0),
#     )).cuda()
